...
object Category{
  def find(category: String): Option[Category] = {
    allCategories.find(_.name == category)
  }
  private val allCategories = List(Bank, Jewelery, Pet, Travel, Clothing, Energy, Car, ElectronicsTechnology,
    RealEstate, Furniture, FitnessAndNutrition, Insurance, BedroomFurniture, Bicycle, Cosmetics, Activewear, Shoe,
    Electronics, WomensClothing, MortgageBroker, Garden, MensClothing, Appliance, TravelAgency)
